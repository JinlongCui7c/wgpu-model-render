...
fn vs_main(
    ...
    // 假设绕 Y 轴旋转 angle_degrees 度
    let angle_degrees = my_r_data.angle; 
    ...
    let rotated_pos = rotation_matrix * model.position;
    ...
    out.clip_position = globals.view_proj * model_matrix * (vec4<f32>(rotated_pos, 1.0) + locals.position);
    return out;
}
